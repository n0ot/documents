...
2.	Redirects MUST be the result of a 301, 302, 307, or 308 HTTP status code response.
3.	Redirects MUST be to resource URLs contained in the Location HTTP response header.
